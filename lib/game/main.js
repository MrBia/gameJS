...
GameEnd = ig.Game.extend({
	EndImage: new ig.Image('media/EndOfLevelBG.png'),
	
	init:function(){
		ig.input.bind(ig.KEY.MOUSE1, 'mouseclick');
		this.e = ig.game.spawnEntity(EntityButtonRestart, 50, 50);
	},
	...
	draw:function(){
		...
		this.EndImage.draw(30, 30);
		this.e.draw();
		var font =  new ig.Font( 'media/04b03.font.png' );
		font.draw('COMPLETE ', 200, 50);
