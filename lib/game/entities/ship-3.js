...
.defines(function(){
    EntityShip3 = EntityShip.extend({
        ...
        init:function(x, y, settings){
           ...
           if( !ig.global.wm ){
                if (this.flip == false) {
                    this.ent = ig.game.spawnEntity('EntityCanonsCover3', this.pos.x+10, this.pos.y+20, {flip:this.flip});
                }
                else{
                    this.ent = ig.game.spawnEntity('EntityCanonsCover3', this.pos.x+85, this.pos.y+20, {flip:this.flip});
                }
