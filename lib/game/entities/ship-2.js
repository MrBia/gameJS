...
.defines(function(){ 
    EntityShip2 = EntityShip.extend({
        ...
        init:function(x, y, settings){
           ...
           if( !ig.global.wm ){
                if (this.flip == false) {
                    this.ent = ig.game.spawnEntity('EntityCanonsCover2', this.pos.x, this.pos.y+40, {flip:this.flip});
                }
                else{
                    this.ent = ig.game.spawnEntity('EntityCanonsCover2', this.pos.x+105, this.pos.y+40, {flip:this.flip});
                }
